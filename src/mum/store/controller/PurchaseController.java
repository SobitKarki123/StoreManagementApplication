...
public class PurchaseController implements Initializable {
	...
	private void handleAdd() {
		PurchaseManager pman = new PurchaseManager();
		...
		PurchaseMaster pd = new PurchaseMaster(billNumber, date.toString(), totalAmount);
		pman.insertPurchase(purchasedItems, pd);
	}
